...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			<h1
				class="font-general-semibold text-2xl md:text-2xl xl:text-2xl text-center sm:text-left text-ternary-dark dark:text-primary-light uppercase"
			>
				Hi,  <br>
				I am Bambang Solehudin
			</h1>
			<p
				class="font-general-medium mt-2 text-lg sm:text-lg  xl:text-xl text-center sm:text-left leading-none text-gray-400"
			>
				A Software Developer From Indonesia
			</p>
			<div class="flex justify-center sm:block">
				<a
					download="Bambang-Resume.pdf"
					href="/files/CV.pdf"
