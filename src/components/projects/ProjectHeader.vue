...
<template>
	<div>
		...
		<div class="text-gray-400 text-left hover:text-indigo-500 dark:hover:text-indigo-200">
			<a :href="singleProjectHeader?.url ?? ''" target="_blank"> {{ singleProjectHeader?.url ?? ' ' }} </a>	
		</div>
		<div class="flex">
