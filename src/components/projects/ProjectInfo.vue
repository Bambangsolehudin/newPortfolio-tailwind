	...
	<div class="block sm:flex gap-0 sm:gap-10 mt-14">
		...
		<div class="w-full sm:w-1/3 text-left">
			...
			<div class="mb-7">
				...
				>
					<span> {{ projectInfo.clientHeading }} </span>
				</p>
				<span class="text-purple-800 dark:text-gray-200 font-bold text-xl"> 
					{{projectInfo.client}}
				</span>
				<!-- <ul class="leading-loose">
					{{ projectInfo.companyInfos }}
					<li
			...
			<!-- <div class="mb-7">
				<p
					class="font-general-medium text-2xl text-ternary-dark dark:text-ternary-light mb-2"
				>
					{{ projectInfo.technologies[0].title }} k
				</p>
				<p
					class="font-general-regular text-primary-dark dark:text-ternary-light"
				>
			...
			<!-- <div>
				<p
					class="font-general-medium text-2xl text-ternary-dark dark:text-ternary-light mb-2"
				>
					{{ projectInfo.socialSharingsHeading }} K
				</p>
